...
var Colors = [256]*ColorProp{
	...
	&ColorProp{
		Num:   1,
		RGBA:  color.RGBA{0xaa, 0x00, 0x00, 0xff},
		Hex:   "#aa0000",
		Names: []string{"dark red 1"},
	},
	&ColorProp{
		Num:   2,
		RGBA:  color.RGBA{0x00, 0xaa, 0x00, 0xff},
		Hex:   "#00aa00",
		Names: []string{"mixed green 1"},
	},
	&ColorProp{
		Num:   3,
		RGBA:  color.RGBA{0xaa, 0x55, 0x00, 0xff},
		Hex:   "#aa5500",
		Names: []string{"mixed orange 1"},
	},
	&ColorProp{
		Num:   4,
		RGBA:  color.RGBA{0x00, 0x00, 0xaa, 0xff},
		Hex:   "#0000aa",
		Names: []string{"mixed blue 1"},
	},
	&ColorProp{
		Num:   5,
		RGBA:  color.RGBA{0xaa, 0x00, 0xaa, 0xff},
		Hex:   "#aa00aa",
		Names: []string{"purple 1"},
	},
	&ColorProp{
		Num:   6,
		RGBA:  color.RGBA{0x00, 0xaa, 0xaa, 0xff},
		Hex:   "#00aaaa",
		Names: []string{"cyan 1"},
	},
	&ColorProp{
		Num:   7,
		RGBA:  color.RGBA{0xb9, 0xb9, 0xb9, 0xff},
		Hex:   "#b9b9b9",
		Names: []string{"light gray"},
	},
	&ColorProp{
		Num:   8,
		RGBA:  color.RGBA{0x55, 0x55, 0x55, 0xff},
		Hex:   "#555555",
		Names: []string{"dark gray"},
	},
	&ColorProp{
		Num:   9,
		RGBA:  color.RGBA{0xff, 0x55, 0x55, 0xff},
		Hex:   "#ff5555",
		Names: []string{"light red"},
	},
	&ColorProp{
		Num:   10,
		RGBA:  color.RGBA{0x55, 0xff, 0x55, 0xff},
		Hex:   "#55ff55",
		Names: []string{"light green"},
	},
	&ColorProp{
		Num:   11,
		RGBA:  color.RGBA{0xff, 0xff, 0x55, 0xff},
		Hex:   "#ffff55",
		Names: []string{"yellow"},
	},
	&ColorProp{
		Num:   12,
		RGBA:  color.RGBA{0x55, 0x55, 0xff, 0xff},
		Hex:   "#5555ff",
		Names: []string{"light blue"},
	},
	&ColorProp{
		Num:   13,
		RGBA:  color.RGBA{0xff, 0x55, 0xff, 0xff},
		Hex:   "#ff55ff",
		Names: []string{"light purple"},
	},
	&ColorProp{
		Num:   14,
		RGBA:  color.RGBA{0x55, 0xff, 0xff, 0xff},
		Hex:   "#55ffff",
